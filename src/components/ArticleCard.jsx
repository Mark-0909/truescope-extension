            ...
            <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-1 flex-1">
                    ...
                    <div className='w-full flex flex-col gap-0'>
                        <div className="flex items-center justify-between text-[7px] text-gray-600 font-bold flex-1">
                            <span>Sup</span>
                            <span>Neu</span>
                            <span>Ref</span>
				        </div>
                    <div className="h-2 flex-1 bg-red-800 rounded-full overflow-hidden relative">
                        <div className="h-2 bg-green-600 rounded-full" style={{ width: `${VerdictScore}%` }}></div>
                    </div>
                    </div>
