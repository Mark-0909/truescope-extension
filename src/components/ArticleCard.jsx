...
export default function ArticleCard({oddEven, support, source, title, Remarks, VerdictScore, ArticleLink}) {
    ...
    return (
        ...
        <div 
            className={`w-full rounded-lg shadow-md p-2 mb-1 cursor-pointer transition-all duration-300 ${oddEven === 'odd' ? 'bg-gray-200/30 hover:bg-gray-300' : 'bg-gray-300 hover:bg-gray-300/20'}`}
