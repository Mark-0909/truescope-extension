    ...
    return (
        ...
        <div className='flex border-b-3 border-black/20'>
            ...
            <p className='flex items-center gap-1 text-[15px] font-semibold text-black/70'>
                ...
                <InfoCard title="Truth Confidence Score" definition="This score represents the confidence level in the truthfulness of the statement based on the analysis of supporting and refuting articles." />
                <span>:</span>
                <span className='font-bold text-base'>49%</span>
            </p>
            <p className='flex items-center gap-1 text-base font-semibold text-black/70'>
                <span>Bias Divergence</span>
                <InfoCard title="Bias Divergence" definition="This score measures the extent of divergence in bias among different sources." />
                <span>:</span>
                <span className='font-bold text-base'>15%</span>
            </p>
            <p className='flex items-center gap-1 text-base font-semibold text-black/70'>
                <span>Bias Consistency Scoring</span>
                <InfoCard title="Bias Consistency Scoring" definition="This score indicates how consistent the bias is across different sources supporting the statement." />
                <span>:</span>
            </p>
